        ...
        <form id="edit-user-form">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="tel" name="phone" id="edit-user-whatsapp" class="w-full px-3 py-2 border border-gray-300 rounded-lg" />
                </div>
            </div>
...
<script>
    ...
    let usersData = @json($users); // Pass users data from PHP to JS
        ...
        document.getElementById('confirm-delete-user-button').onclick = async () => {
            try {
                ...
                if (result.success) {
                    ...
                    usersData = usersData.filter(u => u.id !== user.id); // Update local data
    ...
    document.getElementById('edit-user-form').addEventListener('submit', async function(e) {
        ...
        try {
            ...
            if (result.success) {
                ...
                usersData = usersData.map(u => u.id == userId ? { ...u, name: data.name, email: data.email, whatsapp: data.phone } : u);
                applyFilters();
            } else {
                showToast('error', 'Error', result.message);
            }
